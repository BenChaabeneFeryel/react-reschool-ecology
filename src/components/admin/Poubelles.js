          ...
          <CTable align="middle" className="mb-0 border" color="light" hover responsive>
            <CTableHead color="dark">
              <CTableRow>
                ...
                <CTableHeaderCell className="text-center">Temps de remplissage</CTableHeaderCell>
            ...
            <CTableBody>
              {value.map((item, i) => (
                <CTableRow v-for="item in tableItems" key={item.i}>
                  ...
                  <CTableDataCell className="text-center">{item.capacite_poubelle}</CTableDataCell>
                  <CTableDataCell className="text-center">{item.temps_remplissage}</CTableDataCell>
